 ...
 *   maps-a — map a def, pad/container albedos, train spline + rolling stock, yard tractor
 *   sfx — one-shots
...
const PACKS = [
  ...
  },
  {
    ...
    assets() {
      ...
      return [
        ...
        {
          id: 'grass.albedo',
          path: path.join(materialsDir, grass.file),
          kind: grass.kind,
        },
        {
        ...
        {
          id: 'tractor.mesh',
          path: path.join(carsDir, 'models', 'tractor.glb'),
          kind: 'glb',
        },
        {
          id: 'car.colormap',
          path: path.join(carsDir, 'textures', 'colormap.png'),
          kind: 'png',
        },
      ];
    },
  },
  {
    ...
    assets() {
      const wav = (id) => ({
        id,
        path: path.join(sourceRoot, 'sfx', id),
        kind: 'wav',
      });
      return [
        wav('bang-a.wav'),
        ...
        wav('pump-c.wav'),
        wav('pump-d.wav'),
        wav('breech-open-a.wav'),
        wav('breech-close-a.wav'),
        wav('reload-a.wav'),
        wav('hit.wav'),
        wav('gravel-step-a.wav'),
        wav('gravel-step-b.wav'),
        wav('gravel-step-c.wav'),
        wav('cement-step-a.wav'),
        wav('cement-step-b.wav'),
        wav('cement-step-c.wav'),
        wav('grass-step-a.wav'),
        wav('grass-step-b.wav'),
        wav('grass-step-c.wav'),
